...
def options():
    ...
    parser.add_argument(
        ...
        default=8,
        type=int,
        help="Size of patch to be added to test data (htbd attack)",
    )
    # Files and folders
    parser.add_argument(
        "--name",
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="Different choices for target selection. Options: shuffle/sep-half/sep-1/sep-10",
    )
    ...
    parser.add_argument(
        ...
        choices=["spectral_signatures", "deepknn", "activation_clustering"],
    )
    ...
    parser.add_argument(
        "--load_patch", default="", type=str, help="Path to load image for patch attack"
    )
    parser.add_argument(
